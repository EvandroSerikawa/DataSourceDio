package one.digitainnovationation.desafioAcademia.infra.jackson.ser;
...
public class LocalDateTimeSerializer extends StdSerializer<LocalDateTime> {
    ...
    @Override
    public void serialize(final LocalDateTime value, final JsonGenerator generator, final SerializerProvider provider) throws IOException, IOException {
